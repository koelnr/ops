  ...
  return (
    <div className="rounded-md border">
      <Table>
        ...
        <TableBody>
          {jobs.map(({ booking, customerName, customerPhone, areaName, timeSlotLabel, workerName, bookingStatusLabel, finalPrice, amountDue, hasOpenComplaint }) => (
            <TableRow key={booking.booking_id}>
              <TableCell className="font-medium text-sm">{timeSlotLabel || "—"}</TableCell>
              <TableCell>
              ...
              <TableCell className="text-sm">{workerName || <span className="text-muted-foreground">Unassigned</span>}</TableCell>
              <TableCell>
              ...
              <TableCell className={`text-right tabular-nums text-sm ${amountDue > 0 ? "text-orange-600 dark:text-orange-400 font-medium" : "text-muted-foreground"}`}>
