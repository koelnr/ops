...
export function LeadsSummary({ stats, total }: LeadsSummaryProps) {
  return (
    <div className="grid grid-cols-2 gap-3 sm:grid-cols-4">
      ...
      <FunnelStat label="Contacted" value={stats.contacted} color="text-blue-600 dark:text-blue-400" />
      <FunnelStat label="Converted" value={stats.converted} color="text-green-600 dark:text-green-400" />
      <FunnelStat label="Pending Follow-up" value={stats.pending} color="text-yellow-600 dark:text-yellow-500" />
    </div>
  );
}
